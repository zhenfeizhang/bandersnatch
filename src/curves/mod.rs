...
impl MontgomeryModelParameters for EdwardsParameters {
    ...
    /// COEFF_B = 43133420749626800644911662702407007968989685651477499770299667990488723916667
    #[rustfmt::skip]
    const COEFF_B: Fq = field_new!(Fq, "43133420749626800644911662702407007968989685651477499770299667990488723916667");
